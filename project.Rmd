...
## CHANGE HERE BEFORE SUBMIT
bets <- rbind(bets, list(273235, "ComeOn", NA, "odd_1", 1.48))
bets <- rbind(bets, list(273235, "ComeOn", NA, "odd_x", 4.30))
bets <- rbind(bets, list(273235, "ComeOn", NA, "odd_2", 6.95))

bets <- rbind(bets, list(273235, "youwin", NA, "odd_1", 1.45))
bets <- rbind(bets, list(273235, "youwin", NA, "odd_x", 4.30))
bets <- rbind(bets, list(273235, "youwin", NA, "odd_2", 6.25))

bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_1", 1.49))
bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_x", 4.75))
bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_2", 7.20))


bets <- rbind(bets, list(273240, "ComeOn", NA, "odd_1", 1.95))
bets <- rbind(bets, list(273240, "ComeOn", NA, "odd_x", 3.35))
bets <- rbind(bets, list(273240, "ComeOn", NA, "odd_2", 4.20))

bets <- rbind(bets, list(273240, "youwin", NA, "odd_1", 1.83))
bets <- rbind(bets, list(273240, "youwin", NA, "odd_x", 3.25))
bets <- rbind(bets, list(273240, "youwin", NA, "odd_2", 4.20))

bets <- rbind(bets, list(273240, "Betsafe", NA, "odd_1", 2.03))
bets <- rbind(bets, list(273240, "Betsafe", NA, "odd_x", 3.40))
bets <- rbind(bets, list(273240, "Betsafe", NA, "odd_2", 4.25))


bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_1", 1.38))
bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_x", 5.40))
bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_2", 8.25))

bets <- rbind(bets, list(273239, "youwin", NA, "odd_1", 1.30))
bets <- rbind(bets, list(273239, "youwin", NA, "odd_x", 5.25))
bets <- rbind(bets, list(273239, "youwin", NA, "odd_2", 8.25))

bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_1", 1.39))
bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_x", 5.40))
bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_2", 8.60))


bets <- rbind(bets, list(273232, "ComeOn", NA, "odd_1", 1.29))
bets <- rbind(bets, list(273232, "ComeOn", NA, "odd_x", 6.20))
bets <- rbind(bets, list(273232, "ComeOn", NA, "odd_2", 10.00))

bets <- rbind(bets, list(273232, "youwin", NA, "odd_1", 1.25))
bets <- rbind(bets, list(273232, "youwin", NA, "odd_x", 6.00))
bets <- rbind(bets, list(273232, "youwin", NA, "odd_2", 9.50))

bets <- rbind(bets, list(273232, "Betsafe", NA, "odd_1", 1.29))
bets <- rbind(bets, list(273232, "Betsafe", NA, "odd_x", 6.55))
bets <- rbind(bets, list(273232, "Betsafe", NA, "odd_2", 10.50))


bets <- rbind(bets, list(273245, "ComeOn", NA, "odd_1", 1.77))
bets <- rbind(bets, list(273245, "ComeOn", NA, "odd_x", 3.65))
bets <- rbind(bets, list(273245, "ComeOn", NA, "odd_2", 4.65))

bets <- rbind(bets, list(273245, "youwin", NA, "odd_1", 1.70))
bets <- rbind(bets, list(273245, "youwin", NA, "odd_x", 3.80))
bets <- rbind(bets, list(273245, "youwin", NA, "odd_2", 4.50))

bets <- rbind(bets, list(273245, "Betsafe", NA, "odd_1", 1.82))
bets <- rbind(bets, list(273245, "Betsafe", NA, "odd_x", 3.75))
bets <- rbind(bets, list(273245, "Betsafe", NA, "odd_2", 4.85))

bets <- rbind(bets, list(273247, "ComeOn", NA, "odd_1", 1.29))
bets <- rbind(bets, list(273247, "ComeOn", NA, "odd_x", 5.85))
bets <- rbind(bets, list(273247, "ComeOn", NA, "odd_2", 9.75))

bets <- rbind(bets, list(273247, "youwin", NA, "odd_1", 1.25))
bets <- rbind(bets, list(273247, "youwin", NA, "odd_x", 5.75))
bets <- rbind(bets, list(273247, "youwin", NA, "odd_2", 9.75))

bets <- rbind(bets, list(273247, "Betsafe", NA, "odd_1", 1.33))
bets <- rbind(bets, list(273247, "Betsafe", NA, "odd_x", 5.90))
bets <- rbind(bets, list(273247, "Betsafe", NA, "odd_2", 10.00))
...
```{r}
unplayed_epl_matches <- matches[league_id == 148 & is.na(match_status) & epoch < as.integer(as.POSIXct("2019-12-06"))] 
...
```{r}
#submission = unplayed_predictions[bookmaker_rps_ave == min(bookmaker_rps_ave)]
n = 3
