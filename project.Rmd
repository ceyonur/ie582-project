...
bets <- rbind(bets, list(273235, "youwin", NA, "odd_2", 6.50))

bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_1", 1.48))
bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_x", 4.65))
bets <- rbind(bets, list(273235, "Betsafe", NA, "odd_2", 7.55))
...
bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_1", 1.40))
bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_x", 5.30))
bets <- rbind(bets, list(273239, "ComeOn", NA, "odd_2", 8.00))

bets <- rbind(bets, list(273239, "youwin", NA, "odd_1", 1.33))
bets <- rbind(bets, list(273239, "youwin", NA, "odd_x", 5.25))
bets <- rbind(bets, list(273239, "youwin", NA, "odd_2", 7.25))

bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_1", 1.39))
bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_x", 5.45))
bets <- rbind(bets, list(273239, "Betsafe", NA, "odd_2", 8.35))


bets <- rbind(bets, list(273232, "ComeOn", NA, "odd_1", 1.30))
bets <- rbind(bets, list(273232, "ComeOn", NA, "odd_x", 6.10))
...
bets <- rbind(bets, list(273232, "Betsafe", NA, "odd_x", 6.80))
bets <- rbind(bets, list(273232, "Betsafe", NA, "odd_2", 10.00))
